    ...
    reader.onload = async (evt) => {
      try {
        ...
        const aliasMap: Record<string, string> = {
          ...
          plan: 'planName', planname: 'planName', package: 'planName', policy: 'planName', product: 'planName', productname: 'planName', coverageplan: 'planName',
          startdate: 'planStart', planstart: 'planStart', start: 'planStart', coveragestartdate: 'planStart',
          enddate: 'planEnd', planend: 'planEnd', expiry: 'planEnd', coverageenddate: 'planEnd',
