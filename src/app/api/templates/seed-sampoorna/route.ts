...
export async function POST() {
  try {
    ...
    // Remove existing CureBharat Sampoorna Suraksha template for clean re-seed
    await Template.deleteMany({ name: 'CureBharat Sampoorna Suraksha' });
    ...
    // Page 3: Wellness Plan Benefits (Sampoorna Suraksha version)
    const page3Html = `
        ...
        <table style="width: 100%; border-collapse: collapse; border: 2px solid #000; font-size: 11px;">
          <thead>
            <tr style="background: #007399; color: white;">
              ...
              <th style="border: 2px solid #000; padding: 8px; text-align: center;">CureBharat Sampoorna Suraksha</th>
            </tr>
          </thead>
          <tbody>
            <tr>
            ...
            <tr>
              ...
              <td style="border: 1px solid #000; padding: 8px; text-align: center; font-weight: 700;">Multi-Purpose Cashless / Reimbursement Benefit -<br/>₹2,000</td>
            </tr>
            <tr>
              <td style="border: 1px solid #000; padding: 8px; text-align: center;">
                <div style="display: flex; justify-content: space-between;">
                  <span style="text-align: left;">Specialist and GP Consultation<br/>Cashless / Reimbursement<br/>Benefit</span>
                  <span style="font-weight: 700; border-left: 1px solid #000; padding-left: 10px; display: flex; align-items: center; width: 80px; justify-content: center;">up to<br/>₹2,000</span>
                </div>
              </td>
            </tr>
            <tr>
    ...
    // Page 4: Protection Plan Benefits (Sampoorna Suraksha version)
    const page4Html = `
      <div style="padding: 40px; height: 100%; display: flex; flex-direction: column; background: #fff;">
        <!-- Header -->
        <div style="display: flex; justify-content: flex-end; margin-bottom: 30px;">
    ...
    const pages = [
      ...
      ...termsSampoornaPagesHtml.map((htmlContent, index) => 
        createRawHtmlPage((5 + index), 'terms', `Terms & Conditions - Page ${index + 1}`, htmlContent)
      )
    ];

    const newTemplate = await Template.create({
      name: 'CureBharat Sampoorna Suraksha',
      description: 'Professional brochure style healthcare membership template with complete terms and conditions matching the Sampoorna Suraksha layout',
      category: 'wellness',
