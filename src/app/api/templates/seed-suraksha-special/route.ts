...
export async function POST() {
  try {
    ...
    // Remove existing CureBharat Suraksha Special template for clean re-seed
    await Template.deleteMany({ name: 'CureBharat Suraksha Special' });
      ...
      <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: #fdfdfd; overflow: hidden; z-index: 10;">
        ...
        <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 5; display: flex; flex-direction: column; padding: 60px;">
          ...
          <div style="max-width: 500px;">
            ...
            <div style="color: #0B5D2A; font-family: 'Inter', sans-serif; font-size: 44px; font-weight: 800; line-height: 1.2; margin-bottom: 25px; text-transform: uppercase;">Suraksha Special</div>
    ...
    // Page 3: Wellness Plan Benefits (Suraksha Special version)
    const page3Html = `
        ...
        <table style="width: 100%; border-collapse: collapse; border: 2px solid #000; font-size: 11px;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="border: 1px solid #000; padding: 8px; text-align: center;">Livlong App-based Vitals Tracking (like - BP, Heart Rate, BMI, Weight, Step Counts)</td>
            </tr>
            <tr>
    ...
    // Page 4: Protection Plan Benefits (Suraksha Special version)
    const page4Html = `
      <div style="padding: 40px; height: 100%; display: flex; flex-direction: column; background: #fff;">
        <!-- Header -->
        <div style="display: flex; justify-content: flex-end; margin-bottom: 30px;">
    ...
    const pages = [
      ...
      ...termsSurakshaSpecialPagesHtml.map((htmlContent, index) => 
        createRawHtmlPage((5 + index), 'terms', `Terms & Conditions - Page ${index + 1}`, htmlContent)
      )
    ];

    const newTemplate = await Template.create({
      name: 'CureBharat Suraksha Special',
      description: 'Professional brochure style healthcare membership template with complete terms and conditions matching the Suraksha Special layout',
      category: 'wellness',
