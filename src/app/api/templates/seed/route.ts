...
export async function POST() {
  try {
    ...
    // Remove existing template for clean re-seed
    await Template.deleteMany({ name: 'CureBharat Premium Wellness' });
      ...
      <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: #fdfdfd; overflow: hidden; z-index: 10;">
        ...
        <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 5; display: flex; flex-direction: column; padding: 60px;">
          ...
          <div style="max-width: 500px;">
            ...
            <div style="color: #0B5D2A; font-family: 'Inter', sans-serif; font-size: 44px; font-weight: 800; line-height: 1.2; margin-bottom: 25px; text-transform: uppercase;">Premium Wellness</div>
    ...
    const page1Html = `
      <div style="padding: 40px 50px; height: 100%; display: flex; flex-direction: column; background: #fff;">
        ...
        <div style="margin-bottom: 20px;">
          ...
          <!-- Fake signature using a cursive font or drawn path -->
    ...
    const page3Html = `
      <div style="padding: 40px; height: 100%; display: flex; flex-direction: column; background: #fff;">
        ...
        <div style="text-align: center; font-size: 14px; font-weight: 700; text-decoration: underline; margin-bottom: 20px;">
          WELLNESS PLAN- CUREBHARAT SURAKSHA SPECIAL
        </div>
        ...
        <table style="width: 100%; border-collapse: collapse; border: 2px solid #000; font-size: 11px;">
          <thead>
            <tr style="background: #007399; color: white;">
              ...
              <th style="border: 2px solid #000; padding: 8px; text-align: center;">CureBharat Suraksha Special</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td style="border: 1px solid #000; padding: 8px; font-weight: 700;">Member Details</td>
              <td style="border: 1px solid #000; padding: 8px; text-align: center; font-weight: 700;">Self + Spouse + 2 Children</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="border: 1px solid #000; padding: 8px; text-align: center;">AHC (83 Parameters) - 1</td>
            </tr>
            <tr>
              <td style="border: 1px solid #000; padding: 8px; font-weight: 700;" rowspan="4">OPD Health Benefits</td>
              <td style="border: 1px solid #000; padding: 8px; text-align: center; font-weight: 700;">Multi-Purpose Cashless / Reimbursement Benefit -<br/>₹750</td>
            </tr>
            <tr>
              <td style="border: 1px solid #000; padding: 8px; text-align: center;">
                <div style="display: flex; justify-content: space-between;">
                  <span style="text-align: left;">Specialist and GP Consultation<br/>Cashless / Reimbursement<br/>Benefit</span>
                  <span style="font-weight: 700; border-left: 1px solid #000; padding-left: 10px; display: flex; align-items: center; width: 80px; justify-content: center;">Up to<br/>₹750</span>
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="border: 1px solid #000; padding: 8px; text-align: center;"><span style="font-weight: 700;">₹250</span> Per claim, 1 claim(s) per month per category</td>
            </tr>
            <tr>
              <td style="border: 1px solid #000; padding: 8px; font-weight: 700;">Vitals Tracking</td>
              <td style="border: 1px solid #000; padding: 8px; text-align: center;">Lifelong App-based Vitals Tracking (like - BP, Heart Rate, BMI,<br/>Weight, Step Counts)</td>
            </tr>
            <tr>
              ...
              <td style="border: 1px solid #000; padding: 8px; text-align: left;">
                ...
                Medicine discount - up to 20% Lab discount - up to 50% GP<br/>
                consultation - up to 20%<br/>
                Specialty consultation - up to 20%
              </td>
            </tr>
      ...
      <div style="padding: 40px; height: 100%; display: flex; flex-direction: column; background: #fff;">
        ...
        <table style="width: 100%; border-collapse: collapse; border: 2px solid #000; font-size: 11px;">
          ...
          <tbody>
            ...
            <tr>
              <td style="border: 1px solid #000; padding: 8px; font-weight: 700; height: 50px; vertical-align: top;">Accidental Hospitalization</td>
            ...
            <tr>
              <td style="border: 1px solid #000; padding: 8px; font-weight: 700; height: 80px; vertical-align: middle;">Hospi Cash Benefit 1000 Per day for 30 Days in a Policy<br/>Year, (*24 Hours hospitalization = 1 Day)</td>
    ...
    const page5Html = `
      <div style="padding: 50px; height: 100%; display: flex; flex-direction: column; background: #fff;">
        <div style="text-align: center; font-size: 14px; font-weight: 700; margin-bottom: 30px;">
          Terms and Conditions
        </div>

        <div style="font-size: 11px; font-style: italic; margin-bottom: 30px;">
          TERMS & CONDITIONS - PROTECTION PLAN (WITH ANNEXURE)
        </div>

        <div style="font-size: 11px; line-height: 1.8;">
          <div style="font-style: italic; margin-bottom: 10px;">1. Premium Payment & Policy Validity</div>
          <ul style="margin-left: 40px; margin-bottom: 30px; list-style-type: disc;">
            <li>The policy shall be void ab initio in case of:
              <ul style="margin-left: 20px; list-style-type: circle;">
                <li>Non-receipt of premium</li>
                <li>Dishonour of cheque / failed transaction</li>
              </ul>
            </li>
            <li>Coverage becomes effective only after premium realization</li>
          </ul>

          <div style="border-top: 1px solid #eee; margin-bottom: 30px;"></div>

          <div style="font-style: italic; margin-bottom: 10px;">2. Governing Policy Framework</div>
          <ul style="margin-left: 40px; margin-bottom: 30px; list-style-type: disc;">
            <li>This cover is issued under:
              <ul style="margin-left: 20px; list-style-type: circle;">
                <li>Group Master Policy held by Policyholder</li>
                <li>Insurer standard terms, exclusions, and conditions</li>
              </ul>
            </li>
            <li>In case of dispute:
              <br/>→ Master Policy + Policy Schedule shall prevail
            </li>
          </ul>

          <div style="border-top: 1px solid #eee; margin-bottom: 30px;"></div>

          <div style="font-style: italic; margin-bottom: 10px;">3. Disclosure & Misrepresentation</div>
          <ul style="margin-left: 40px; margin-bottom: 10px; list-style-type: disc;">
            <li>Policy is issued based on information provided by the insured/ member</li>
            <li>Any:
              <ul style="margin-left: 20px; list-style-type: circle;">
                <li>Misstatement</li>
          ...
          <div style="margin-bottom: 30px; margin-left: 20px; font-style: italic;">
            → Shall result in policy cancellation and claim repudiation
          </div>

          <div style="border-top: 1px solid #eee; margin-bottom: 30px;"></div>

          <div style="font-style: italic; margin-bottom: 10px;">4. Coverage Scope Limitation</div>
          <ul style="margin-left: 40px; margin-bottom: 30px; list-style-type: disc;">
            <li>Policy wording includes all standard benefits of Insurer</li>
            <li>However, coverage applicable will be restricted to COI / Schedule only</li>
          </ul>

          <div style="border-top: 1px solid #eee; margin-bottom: 30px;"></div>

          <div style="font-style: italic; margin-bottom: 10px;">5. Assignment Clause</div>
          <ul style="margin-left: 40px; margin-bottom: 30px; list-style-type: disc;">
            <li>Policy is assigned to Master Policyholder</li>
            <li>All claim payouts shall be made to:
              <br/>→ Assignee / Nominee / Legal heir, as applicable
            </li>
          </ul>

          <div style="border-top: 1px solid #eee; margin-bottom: 30px;"></div>

          <div style="font-style: italic; margin-bottom: 10px;">6. Free Look & Cancellation</div>
          <ul style="margin-left: 40px; margin-bottom: 30px; list-style-type: disc;">
            <li>Free Look Period: 15 days from issuance</li>
          </ul>
        </div>

        <div style="margin-top: auto; text-align: center; font-size: 11px;">
          Page 1
        </div>
      </div>
    `;

    const createRawHtmlPage = (pageIndex: number, pageType: any, title: string, htmlContent: string): ITemplatePage => ({
      pageIndex,
      pageType,
      title,
    ...
    const newTemplate = await Template.create({
      ...
      description: 'Professional brochure style healthcare membership template',
      category: 'wellness',
      pageCount: 6,
      brandColors,
      createdBy: 'admin',
      pages: [
        ...
        createRawHtmlPage(5, 'terms', 'Terms & Conditions', page5Html)
      ],
      isActive: true
    });
